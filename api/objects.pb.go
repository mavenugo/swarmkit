...
type Node struct {
	...
	LbAttachments map[string]*NetworkAttachment `protobuf:"bytes,10,rep,name=lb_attachments,json=lbAttachments" json:"lb_attachments,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *Node) Copy() *Node {
	...
	if m.LbAttachments != nil {
		o.LbAttachments = make(map[string]*NetworkAttachment)
		for k, v := range m.LbAttachments {
			o.LbAttachments[k] = v.Copy()
		}
	}
...
func (this *Node) GoString() string {
	...
	keysForLbAttachments := make([]string, 0, len(this.LbAttachments))
	for k, _ := range this.LbAttachments {
		keysForLbAttachments = append(keysForLbAttachments, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForLbAttachments)
	mapStringForLbAttachments := "map[string]*NetworkAttachment{"
	for _, k := range keysForLbAttachments {
		mapStringForLbAttachments += fmt.Sprintf("%#v: %#v,", k, this.LbAttachments[k])
	}
	mapStringForLbAttachments += "}"
	if this.LbAttachments != nil {
		s = append(s, "LbAttachments: "+mapStringForLbAttachments+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Service) MarshalTo(data []byte) (int, error) {
	...
	if m.UpdateStatus != nil {
		...
		n15, err := m.UpdateStatus.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.PreviousSpec != nil {
		...
		n16, err := m.PreviousSpec.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *Task) MarshalTo(data []byte) (int, error) {
	...
	n21, err := m.ServiceAnnotations.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n21
...
func (m *NetworkAttachment) MarshalTo(data []byte) (int, error) {
	...
	if m.Network != nil {
		...
		n25, err := m.Network.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *Cluster) MarshalTo(data []byte) (int, error) {
	...
	n32, err := m.RootCA.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n32
...
func (this *Node) String() string {
	...
	s := strings.Join([]string{`&Node{`,
		...
		`LbAttachments:` + mapStringForLbAttachments + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Node) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			if m.LbAttachments == nil {
				m.LbAttachments = make(map[string]*NetworkAttachment)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &NetworkAttachment{}
				if err := mapvalue.Unmarshal(data[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				m.LbAttachments[mapkey] = mapvalue
			} else {
				var mapvalue *NetworkAttachment
				m.LbAttachments[mapkey] = mapvalue
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorObjects = []byte{
	...
	,
}
